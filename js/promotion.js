...
var template = '<p style="margin: 12px 0 10px 0" class="title"><strong>Akadálymentes térképezés</strong></p>';
template+= '<div style="float: left; padding: 0 0 0 8px"><a href="https://www.facebook.com/events/139192116425139/" target="_blank"><img src="/kepek/map-159714_640.png" alt="Akadálymentes térképezés logója"></a></div>';
template+= '<div style="float: left"><span><strong>Győr</strong>, szeptember 26.</span>';
template+= '<p style="margin: 8px 0" class="countdown"><span class="remaining-days">0</span> nap ';
...
template+= '<div class="fbstyle"><a class="fbpage" href="https://www.facebook.com/events/139192116425139/" target="_blank">Esemény oldal</a></div></div><div style="clear: both"></div>';
